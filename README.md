...
<p align="center">
  <strong>JASEE</strong> · <em>Just A Smart Ergonomics Evaluator</em><br/>
  An AI-powered posture &amp; workspace analysis service that detects body posture and desk environment in real-time using Computer Vision, delivering personalized ergonomic feedback based on VDT and RULA standards.
</p>
